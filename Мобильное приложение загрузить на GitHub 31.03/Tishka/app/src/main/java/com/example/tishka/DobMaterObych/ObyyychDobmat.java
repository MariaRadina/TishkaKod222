...
import com.example.tishka.Instrukcia;
...
public class ObyyychDobmat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obyyych_dobmat);
        ...
        strelka.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent regIntent= new Intent(ObyyychDobmat.this, ObychaMater.class);
    ...
    private void SaveInfoDataBase() {
        ...
        ObRef.child(InfoRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){

                    loadingBar.dismiss();
                    Toast.makeText(ObyyychDobmat.this, "Информация добавлена", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ObyyychDobmat.this, "Ошибка:" + message, Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
        });
